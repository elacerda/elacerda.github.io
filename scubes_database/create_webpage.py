        ...
        <main>
            ...
            <div>
                <details>
                    ...
                    <a href="https://minerva.ufsc.br/~lacerda/s-cubes/img/{SNAME}_imgs_flux.png" target="_blank"><img src="https://minerva.ufsc.br/~lacerda/s-cubes/img/{SNAME}_imgs_flux.png" style="max-width:1000px;width:100%" alt="Images in the 12 bands. Log flux density, in units of $10^{-18}$ erg/s/cm$^2$/\AA"  class="object_img"></a><br>
                    Images in the 12 bands. Log flux density, in units of \\(10^{-18}\\) erg/s/cm\\(^2\\)/\\(\r{A}\\).<br><br>
            ...
            <div class="other_plot_wrapper">
                ...
                <div>
                    <details>
                        ...
                        <i>Right</i>: Mean photo-spectra in circular annulii of 10 pixels, in units of \\(10^{-18}\\) erg/s/cm\\(^2\\)/\\(\r{A}\\) per pixel, and coloured by the same colors used in <i>left</i> plot. The dotted horizontal lines mark the flux-density levels corresponding to r-band surface brightnesses 23, 24, and 25 AB mag/arcsec\\(^2\\).<br><br>
                    </details>
                </div>
            </div>
        </main>
